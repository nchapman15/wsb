## Class file, Stock class can show the price, volume, mentions, etc. for a given ticker
## Forum class can show the mention leaders after an input date
...
class Stock():
    ...
    def __init__(self, ticker):
        ...
        ## pull from SQL the mentions of a given ticker by days interval
